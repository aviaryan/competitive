...
ll optGrid(bool madMode){
	...
	if (mxH2 - mxH1 > 1){
		if (mxH1 != 0){
			...
			if (t_min < m_min) m_type = 1; m_min = t_min;
		}
		if (mxH2 != n){
			...
			if (t_min < m_min) m_type = 2; m_min = t_min;
		}
		if (mxH1 != 0 && mxH2 != n && (mxH2 - mxH1) > 2){
			...
			if (t_min < m_min) m_type = 5; m_min = t_min;
		}
	}
	if (mxV2 - mxV1 > 1){
		if (mxV1 != 0){
			...
			if (t_min < m_min) m_type = 3; m_min = t_min;
		}
		if (mxV2 != n){
			...
			if (t_min < m_min) m_type = 4; m_min = t_min;
		}
		if (mxV1 != 0 && mxV2 != n && (mxV2 - mxV1) > 2){
			...
			if (t_min < m_min) m_type = 6; m_min = t_min;
		}
	}
	// madmode
	if ((madMode) && type == 0){
